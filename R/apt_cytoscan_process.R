apt.cytoscan.process <- function(CEL = NULL, samplename = NULL, dual.norm = FALSE, normal.diploid = FALSE, out.dir = getwd(), temp.files.keep = FALSE, force.OS = NULL, apt.build = "na33.r4") {
  ...
  knownbuilds <- c("na33.r2", "na33.r1", "na33.r4", "na36.r1")
  ...
  } else if (!(my.os %in% os.list)) stop(paste0("Current OS [", my.os, "] not supported ! If you are sure of your OS support, use force.OS option with any of 'linux', 'windows'"))
